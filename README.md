...
- **Data Scientist: Machine Learning Career Path (Codecademy)** ![](https://geps.dev/progress/70): Includes resources from the "Data Scientist Career Path" on Codecademy.
